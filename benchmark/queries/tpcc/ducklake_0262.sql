...
date_spine AS (
		SELECT DATE '2026-06-05' AS report_as_of_date
...
unpivoted AS (
	...
	SELECT
		...
		CASE
			WHEN ls.stock_quantity > 66 THEN 'connected'
			WHEN ls.stock_quantity > 46 THEN 'registered'
			ELSE 'pending'
		END AS metric_status,
		ls.item_id,
		ls.stock_quantity,
