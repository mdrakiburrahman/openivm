...
qualify_window_pass_2 AS (
	SELECT
		...
		NTILE(4) OVER (
			...
			ORDER BY
				qr.extended_amount DESC,
				qr.order_id ASC,
				qr.line_number ASC,
				qr.customer_id ASC,
				qr.item_id ASC,
				qr.credit_code ASC,
				qr.fulfillment_state ASC,
				qr.account_state ASC,
				qr.customer_balance DESC,
				qr.stock_quantity ASC,
				qr.total_history_amount ASC,
