...
parameters AS (
	SELECT
		DATE '2026-06-06' AS start_date,
		DATE '2026-06-14' AS end_date,
...
date_spine AS (
		SELECT DATE '2026-06-06' AS report_as_of_date
...
unpivoted AS (
	...
	SELECT
		...
		CASE
			WHEN ls.stock_quantity > 71 THEN 'connected'
			WHEN ls.stock_quantity > 51 THEN 'registered'
			ELSE 'pending'
		END AS metric_status,
		ls.item_id,
		ls.stock_quantity,
