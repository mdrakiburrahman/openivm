...
parameters AS (
	SELECT
		DATE '2026-06-09' AS start_date,
		DATE '2026-06-20' AS end_date,
...
date_spine AS (
		SELECT DATE '2026-06-09' AS report_as_of_date
...
unpivoted AS (
	...
	SELECT
		...
		CASE
			WHEN ls.stock_quantity > 69 THEN 'connected'
			WHEN ls.stock_quantity > 49 THEN 'registered'
			ELSE 'pending'
		END AS metric_status,
		ls.item_id,
		ls.stock_quantity,
