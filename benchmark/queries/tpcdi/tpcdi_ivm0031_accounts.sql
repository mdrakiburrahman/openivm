-- {"operators": "OUTER_JOIN,WINDOW,CASE", "complexity": "medium", "is_incremental": true, "has_nulls": false, "has_cast": false, "has_case": true, "source": "ivm-bench/duckdb", "tpcdi": "accounts"}
