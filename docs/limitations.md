...
| `FULL OUTER JOIN` aggregate views | Group-recompute for affected groups. Enable `ivm_full_outer_merge = true` (default: `false`) for a MERGE-based strategy (Zhang & Larson). |
